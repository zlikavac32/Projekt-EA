 ...
 *
 */
public class SIAPopulacija<R, E, T extends Krajolik<E>> extends Populacija<R, E, T> {

	protected int brojKlonova;
	
	protected Mutator<R> mutator;
	
	public SIAPopulacija(int brojAntiTijela, int brojKlonova, RandomGenerator generator, Mutator<R> mutator) {
